...
?>
	<div class="container">
					...
					<div class = "registarForm">
						...
						<form role="form" method="post" onsubmit="return validateForm()"  action="volunteer" id="registaVoluntario">
							...
							<div class="form-group">
								<input type="text" name="username" class="form-control" id="exampleInputName2" placeholder="Nome próprio" value= " <?php echo $nome; ?> " required>
							</div>
							...
							<div class="form-group row">
								...
								<input type="date" name="birthDay" id="dataN" placeholder= "<?php echo $data_nascimento; ?> " value= " <?php echo $data_nascimento; ?> " onchange= "changeDate()" >
							</div>
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" id="telefone" placeholder="<?php echo $telefone; ?>" name="phone" value= "<?php $telefone; ?> ">
							...
							<div class= "form-group row" id= "alteraPass">
								...
								<div class = "passwords" id="passID" style="display:none">
									<input type="password" class="form-control" id="inputPassword1" placeholder="Password" name="pass" value= "<?php echo $password; ?>" required>
            ...
            <div class="form-group">
            <a href="<?php echo base_url('volunteer/edit/schedule'); ?>" class="btn btn-lg btn-primary btn-block">Editar Disponibilidade</a>
			  </div>
              <div class="form-group">
                <a href="<?php echo base_url('volunteer/edit/areas'); ?>" class="btn btn-lg btn-primary btn-block">Editar Áreas de Interesse e Grupos</a>
			  </div>
		  </div>
